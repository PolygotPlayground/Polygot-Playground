document.addEventListener("DOMContentLoaded", function () { 
    ...
    const questions = [ 
        { question: "How do you say 'Hello' in Swahili?", options: ["Habari", "Sawa", "Nzuri", "Karibu"], answer: "Habari" }, 
        { question: "What is the response to 'Habari'?", options: ["Nzuri", "Sawa", "Poa", "Shikamoo"], answer: "Sawa" }, 
        { question: "How do you say 'Good night' in Swahili?", options: ["Kwa heri", "Habari za jioni", "Lala salama", "Mambo"], answer: "Lala salama" } 
    ]; 
